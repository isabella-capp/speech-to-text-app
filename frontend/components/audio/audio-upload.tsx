...
interface AudioUploaderProps {
  ...
  hideTranscribeButton?: boolean // Added optional prop to hide transcribe button for evaluation mode
}
...
export function AudioUploader({
  ...
  onDragActiveChange,
  isTranscribing,
  hideTranscribeButton = false, // Default to false to maintain existing behavior
}: AudioUploaderProps) {
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2 justify-center">
              ...
              <Button
                ...
                variant="outline"
                className="py-5 rounded-full bg-gradient-to-r from-red-400 to-red-600 hover:from-orange-600 hover:to-red-700"
              >
